...
INSERT INTO `Emp_renapo` VALUES (1,'H','Supervisor',1,'IAMOIWBCG23U7','Alberto','Gomez','Prada'),(2,'H','Supervisor',3,'AQIMDHWZCFT81','Franco','Osorio','Cruz'),(3,'H','Encargado',4,'JAH1YBAGWT4I9','Juanito','Torres','Aguila'),(4,'H','Encargado',6,'HYQBAIWUHYST6','Moises','Solis','Pasos'),(5,'H','Capturista',7,'IAMOIWBCG23U7','Alberto','Escabeche','Prada'),(6,'M','Administrativo',8,'IAMOIWBCG23U7','Gloria','Mendoza','Ordaz'),(7,'M','Capturista',1,'IAMOIWBCG23U7','Itzel','Gomez','Perez'),(8,'M','Administrativo',4,'IAMOIWBCG23U7','Miriam','Cruz','Prada'),(9,'M','Adminisitrativo',5,'IAMOIWBCG23U7','Mons','Estrada','Maria'),(10,'M','Capturista',7,'AQIMDHWZCFT81','Mayra','Marquez','Cruz');
...
INSERT INTO `Nuevo_usuario` VALUES (1,'Salas Montoya Karla Josete',22,'M'),(2,'Peruano Solis Eric',23,'H'),(3,'Flores Perez Gabriela',24,'M'),(4,'Decano Guerrero Valeria',23,'M'),(5,'Molina Toral Ana Lizbeth',22,'M'),(6,'Ordaz Vazquez Alejandro',21,'H'),(7,'Neria Franco Cassandra Sharon',22,'M'),(8,'Mancilla Avila Luis Daniel',23,'H'),(9,'Silva Cruz Bailey Joceline',22,'M'),(10,'Naomi Mayte Gonzalez Gonzalez Cruz',19,'M'),(11,'Jessica Naomi Cuatpotzo Isaias',21,'M'),(12,'Franciso Javier Robles',27,'H');
...
INSERT INTO `Rep_familia` VALUES ('EDRJ021325DDFRRNA9',4000.00,'Miguel','Rosas','Rojas','Casado','Universidad','Ingeniero'),('HEMJ021225HDFRRNA9',9500.50,'Alvaro','Diaz','Paz','Casado','Universidad','Ingeniero');
...
-- Dump completed on 2025-04-14 12:24:01
